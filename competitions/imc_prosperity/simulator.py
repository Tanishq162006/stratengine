"""IMC Prosperity 4 simulator harness.
...
Prosperity 4 products:
  Tutorial: EMERALDS (stable, lim 80), TOMATOES (drifting, lim 80)
  Round 1+2: INTARIAN_PEPPER_ROOT (stable, lim 80), ASH_COATED_OSMIUM (volatile, lim 80)

Usage (standalone script — called by evaluator):
    python simulator.py --code trader.py --data prices.csv \\
        --start 2026-04-14 --end 2026-04-17 --products INTARIAN_PEPPER_ROOT,ASH_COATED_OSMIUM
"""
...
POSITION_LIMITS: Dict[str, int] = {
    ...
    # Legacy (Prosperity 3) — kept for backwards compatibility
